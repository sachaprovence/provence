...
export async function GET(_request: Request, { params }: Params) {
  ...
  try {
    ...
    return toApiErrorResponse(error, { route: "GET /api/companies/[id]" });
  }
}
...
export async function PUT(request: Request, { params }: Params) {
  ...
  try {
    ...
    return toApiErrorResponse(error, { route: "PUT /api/companies/[id]" });
  }
}
...
export async function DELETE(_request: Request, { params }: Params) {
  ...
  try {
    ...
    return toApiErrorResponse(error, { route: "DELETE /api/companies/[id]" });
  }
}
