...
export async function GET() {
  ...
  try {
    ...
    return toApiErrorResponse(error, { route: "GET /api/settings/notification-preferences" });
  }
}
...
export async function PUT(request: Request) {
  ...
  try {
    ...
    return toApiErrorResponse(error, { route: "PUT /api/settings/notification-preferences" });
  }
}
