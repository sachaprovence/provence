...
export const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/companies", label: "Entreprises", roles: ["OWNER_ADMIN", "SALES"] },
  ...
  { href: "/compta/produits", label: "Produits", roles: ["OWNER_ADMIN"] },
  { href: "/compta/stock", label: "Stock", roles: ["OWNER_ADMIN"] },
  { href: "/compta/depenses", label: "Dépenses", roles: ["OWNER_ADMIN"] },
  { href: "/compta/fournisseurs", label: "Fournisseurs", roles: ["OWNER_ADMIN"] },
  { href: "/compta/achats", label: "Achats", roles: ["OWNER_ADMIN"] },
  { href: "/compta/tva", label: "TVA", roles: ["OWNER_ADMIN"] },
  { href: "/compta/exports", label: "Exports", roles: ["OWNER_ADMIN"] },
  { href: "/compta/historique", label: "Historique", roles: ["OWNER_ADMIN"] },
